...
* 出来の悪いシンゴジみたいなのがいるので倒す
    * 二十一:HP800?
        ...
        * 頭突き：突然停止したらだいたいコレ。微妙なモーションがあるのでじっと見てたらなんとかわかる。避けて頭に攻撃しよう。
        * 暴れ出すやつ：クソ技しね
        * 雷：帯電してﾋﾟｷｰﾝって音の後、雷が5本降る。4本目が落ちた瞬間に21が動き出すので注意。
...
*  そこを通って浮遊カメラの反対側で一時停止！
    *  赤いシタイのところを今のママ通るとソクシするので、ニキータを使う
    ...
    <div id="img3" style="display:none;">
        <img src = "img/nic0.PNG" >
        <img src = "img/nic1.PNG" >
        <p>これ以上出ると死ぬ</p>
        <img src = "img/nic-route.PNG" >
        <p>黄色が自分。赤線のルートでニキータを打つ。途中で青色、扉に当て破壊した後、その中のセキュリティに当てる必要がある。</p>
    </div>
*  ニキータで探索、すぐ右に扉が2つあるが、奥の方、2つ目の扉に当たるようにニキータを3D視点で打って誘導する。
<br>
<a href="#" id="view4" onClick="t_view(4);return false;">このへん</a>
<a href="#" id="hidden4" onClick="t_hidden(4);return false;" style="display:none;">隠す</a>
<div id="img4" style="display:none;">
    <img src = "img/nic2.PNG" >
    <p>赤丸の扉</p>
</div>
*  もう一度打ち、破壊した扉の部屋の中まで誘導、緑色のセキュリティに当てる
<br>
<a href="#" id="view5" onClick="t_view(5);return false;">これ</a>
<a href="#" id="hidden5" onClick="t_hidden(5);return false;" style="display:none;">隠す</a>
<div id="img5" style="display:none;">
    <img src = "img/nic3.PNG" >
</div>
*  メッセージでセキュリティが云々といわれる
*  浮遊カメラ方面の扉を破壊してナインシステムに移動する
*  ナインシステムでイベントを見る
* 強制的に退出させられるのでもう一度入りナインシステムを確認する
*  (任意)ナインシステムに攻撃しないように2人に話しかける
*  チャンに報告しに行く
*  マンガブに戻る
...
*  ACみたいなやつを倒す
    ...
    * フリハタ：HP700～750？
        * 実質ラスボスくらい強い(個人感)
        * ダメージがクソ痛いので要準備。逃げつつニキータなどがオススメ。
        * 地面に赤丸が出るやつ：結構痛いｽﾊﾟｧﾝみたいな音がするやつはソクシなのでくらわないようにしよう
        * ひらひら：邪魔。
        * ひらひら突撃：うまく行けば上に乗れるのでそこから打ち下ろし風味で攻撃することもできる。だがビームは普通に当たるので過信しないほうがいい。
        * 追尾ミサイル → ビーム：ミサイルは刀攻撃で迎撃可能、その後クソビームが来るがフリハタ付近には判定がないので近付こう
